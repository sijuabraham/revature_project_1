...
// filterElement = document.querySelector('#status-filter');
// filterOutput = filterElement.options[1].value;  //filterElement.selectedIndex
// console.log(filterOutput);

// console.log(filterElement.opetions[i].value); //accessing data using reimbursements as key
// filter_status_array = filterElement.opetions[i] //saving variable as array
//   for (let i of filter_status_array){ //looping over array and each element is a dictionary
//     console.log(filterElement.opetions[i].value);
//       // user_reimbursement(reimbursements)
//   }
// var dropdownValue;
// var filterSearchBox;
// var tempo = selectedStatusFilter();

// function selectedStatusFilter() {
//   var filterSearchBox = document.querySelector('#status-filter');
//   var dropdownValue = filterSearchBox.options[filterSearchBox.selectedIndex].text;
...
const dropDown = document.getElementById('status-filter') 
 dropDown.addEventListener('change', async function(event) { 
  ...
  // dropDown.addEventListener('click', selectedStatusFilter(tempo));
 }) 


// dropDown.addEventListener('onchange', selectedStatusFilter);
...
// function user_reimbursement_status(reimbursements){
